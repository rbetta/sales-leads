...
/**
 * A component for rendering a multi-line textarea field.
 * @author Randall Betta
 *
 */
class AdminFieldTextArea extends AbstractFormField
{
     ...
     * @param string|null $value The value for the field.
     */
    ...
    {
        return view('components.form.admin.field-textarea');
    }
