...
/**
 * A component for rendering a single-line text field.
 * @author Randall Betta
 *
 */
class AdminFieldText extends AbstractFormField
{
     ...
     * @param string|null $value The HTML "value" attribute for the field.
     */
    ...
    {
        return view('components.form.admin.field-text');
    }
