...
/**
 * A factory for creating LocalizedTextValueData instances.
 */
class LocalizedTextValueDataFactory extends AbstractDataObjectFactory
{
    
    /**
     * Create a new, empty instance of the class this factory handles.
     * @return LocalizedTextValueData
     */
    public function create() : LocalizedTextValueData
    {
        return \App::make(LocalizedTextValueData::class);
    }
