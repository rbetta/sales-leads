...
/**
 * A factory for creating ClientData instances.
 */
class ClientDataFactory extends AbstractDataObjectFactory
{
    ...
    {
        return \App::make(ClientData::class);
    }
    ...
    protected function assignCustomProperties(\stdClass $properties, iDataObject $instance) : self
    {
        $instance
            ...
            ->setIsTest(        (bool)  $properties->isTest     )
            ->setIsInternal(    (bool)  $properties->isInternal )
            ;
    }
